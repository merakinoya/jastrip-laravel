...
<section class="container">
    ...
    <div class="mb-3">
        <div class="float-right">
            @can('create', new App\LocationMap)
            <a href="{{ route('locationmap.create') }}" class="btn btn-success">{{ __('outlet.create') }}</a>
            @endcan
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    <form method="GET" action="" accept-charset="UTF-8" class="form-inline">
                        ...
                        <a href="{{ route('locationmap.index') }}" class="btn btn-link">{{ __('app.reset') }}</a>
                    </form>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('locationmap.show', $outlet->id) }}" id="show-outlet-{{ $outlet->id }}">{{ __('app.show') }}</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
