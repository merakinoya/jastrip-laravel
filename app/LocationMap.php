...
class LocationMap extends Model
{
    ...
    public function getNameLinkAttribute()
    {
        ...
        $link = '<a href="'.route('locationmap.show', $this).'"';
        $link .= ' title="'.$title.'">';
        $link .= $this->name;
        $link .= '</a>';
    ...
    {
        $mapPopupContent = '';
        $mapPopupContent .= '<div class="my-2"><strong>'.__('locationmap.name').':</strong><br>'.$this->name_link.'</div>';
        $mapPopupContent .= '<div class="my-2"><strong>'.__('locationmap.coordinate').':</strong><br>'.$this->coordinate.'</div>';
